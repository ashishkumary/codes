...
then this constructor becomes a conversion constructor because 
...
/*
"Ashish" is of const char [7] type. So compiler firstly convert Ashish to string type,
 then that string will be converted to entity type using first constructor. Which will throw error because,
